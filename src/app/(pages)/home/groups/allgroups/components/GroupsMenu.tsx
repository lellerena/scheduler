...
export default function GroupsList({
			...
			data.map((grp, index) => (
				<React.Fragment key={index}>
					<section
						...
						className="flex flex-row border shadow-sm min-h-[150px] rounded-lg p-8 relative hover:border-gray-50 transition-all cursor-pointer"
					>
	...
	return selectedID ? (
		<Menu userID={userID} grp={selectedGroup} onClose={reset} />
	) : (
		ls
	);
}
